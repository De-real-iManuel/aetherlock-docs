...
**Symptoms**:
```
Error: ValidationException: The model 'anthropic.claude-3-sonnet' is not available
```

**Root Cause**: Model not available in region or incorrect model ID
...
# Update model ID in environment variables
