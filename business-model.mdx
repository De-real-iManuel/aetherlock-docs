...
| **AI Infrastructure** | 2.0% | AWS Bedrock, compute costs | $20 |
...
- Average verification: 3K input + 1K output tokens
- Cost per verification: (3 × $0.003) + (1 × $0.015) = $0.024

Annual AI Costs by Volume:
- 10K transactions: $240
- 100K transactions: $2,400  
- 1M transactions: $24,000
- 10M transactions: $240,000

Revenue vs AI Costs:
- $1,000 escrow → $100 revenue → $0.024 AI cost → 99.976% margin
- $10,000 escrow → $1,000 revenue → $0.024 AI cost → 99.998% margin
```
...
Variable Cost per Transaction: $0.33
Revenue per Transaction (avg): $300

Break-Even = Fixed Costs / (Revenue - Variable Costs)
Break-Even = $755K / ($300 - $0.33) = 2,520 transactions
...
- Revenue: $2.5M
- Variable costs: $3.3K (10K × $0.33)
- Fixed costs: $755K
- Profit: $1.74M (69.6% margin)

Year 3 (200K transactions):
- Revenue: $100M
- Variable costs: $66K (200K × $0.33)
- Fixed costs: $10M
- Profit: $89.9M (89.9% margin)

Year 5 (500K transactions):
- Revenue: $300M
- Variable costs: $165K (500K × $0.33)
- Fixed costs: $45M
- Profit: $254.8M (84.9% margin)
```
...
- Bulk pricing on AWS Bedrock at scale
