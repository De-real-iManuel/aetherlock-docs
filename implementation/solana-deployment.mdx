...
[programs.localnet]
aetherlock = "2kkNXo7nJ5WikLP64eZZbAiNDzdGj7d2B7XL3YqK5b6N"
...
<Note>
**Devnet Program ID**: `2kkNXo7nJ5WikLP64eZZbAiNDzdGj7d2B7XL3YqK5b6N` - Deployed and verified on Solana Devnet.
</Note>
...
export const AETHERLOCK_PROGRAM_ID_DEVNET = new PublicKey(
  "2kkNXo7nJ5WikLP64eZZbAiNDzdGj7d2B7XL3YqK5b6N"
);
```
