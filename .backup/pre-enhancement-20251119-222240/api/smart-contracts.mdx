...
### Mainnet
- **Solana Program**: `AEtherLockProgram1111111111111111111111111`
- **ZetaChain Universal App**: `0x742d35Cc6634C0532925a3b8D4C9db96DfbB8E24`
- **Somnia Settlement**: `0x1234567890123456789012345678901234567890`
...
Allows client to dispute AI verification results.
...
Smart contracts receive AI verification results from Arcanum.ai through Chainlink oracles. The verification result structure includes:
...
The smart contract verifies that AI results are authentically signed by Arcanum.ai:
