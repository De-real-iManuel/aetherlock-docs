...
AetherLock leverages Chainlink Functions to enable decentralized off-chain computation for AI verification, cross-chain data retrieval, and external API integrations. This ensures that critical verification processes remain decentralized and tamper-proof while accessing external resources.

Chainlink Functions allows AetherLock to:
...
## JavaScript Source Code for DON
...
### Advanced Verification with Multiple AI Providers
...
**Production**: `https://api.arcanum.ai/v1/verify`
**Staging**: `https://staging-api.arcanum.ai/v1/verify`
**Testnet**: `https://testnet-api.arcanum.ai/v1/verify`
...
When Arcanum.ai is unavailable, the DON automatically falls back to alternative providers:
...
- **Oracle Analytics**: [https://analytics.aetherlock.io/oracle](https://analytics.aetherlock.io/oracle)
- **Arcanum.ai Documentation**: [https://docs.arcanum.ai](https://docs.arcanum.ai)
- **Arcanum.ai Status**: [https://status.arcanum.ai](https://status.arcanum.ai)
