...
AetherLock's Proof-of-Task Verification (PoTV) uses Arcanum.ai, a specialized AI verification provider, to analyze your submitted evidence against the original project requirements. The process involves multiple layers of analysis:
...
### Arcanum.ai Verification

AetherLock uses Arcanum.ai as the primary AI verification provider. Arcanum.ai is purpose-built for task completion analysis, offering:

- **Specialized Analysis**: Trained specifically for freelance work verification
- **High Accuracy**: 94.2% overall accuracy rate across all decisions
- **Fast Processing**: Average verification time of 4.2 minutes
- **Fallback Support**: Automatic failover to OpenAI, Claude, or Gemini if needed

**Why Arcanum.ai?**
- Lower latency (40% faster than general-purpose AI platforms)
- Better accuracy for edge cases (15% improvement)
- Predictable pricing ($0.05 per verification)
- Specialized training on task verification scenarios

## Frequently Asked Questions

<AccordionGroup>
<Accordion title="How accurate is the AI verification system?">
AetherLock's AI verification system, powered by Arcanum.ai, maintains a 94.2% accuracy rate across all decisions. High-confidence decisions (85%+ score) have a 97.8% accuracy rate, while medium-confidence decisions requiring human review have an 89.1% accuracy rate. The system is continuously improved based on feedback and outcomes.
</Accordion>
...
AetherLock uses Arcanum.ai as the primary AI verification provider. Arcanum.ai is specialized for task completion analysis and offers superior accuracy and speed compared to general-purpose AI platforms. If Arcanum.ai is unavailable, the system automatically falls back to OpenAI, Claude, or Gemini to ensure continuous service.
</Accordion>
