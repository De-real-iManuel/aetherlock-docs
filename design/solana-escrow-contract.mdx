...
pub struct EscrowAccount {
    ...
    pub token_mint: Optionbelow Pubkeyabove ,
    ...
    pub evidence_hash: Optionbelow Stringabove ,
    /// AI verification result
    pub verification_result: Optionbelow VerificationResultabove ,
    /// zkMe KYC verification status
    pub kyc_verified: bool,
    /// Treasury fee amount (2 percent of escrow amount)
...
pub struct InitializeEscrowbelow 'infoabove  {
    #[account(
        init,
        payer = payer,
    ...
    pub escrow_account: Accountbelow 'info, EscrowAccountabove ,
    
    #[account(mut)]
    pub payer: Signerbelow 'infoabove ,
    
    /// CHECK: Payee address validation handled in instruction
    pub payee: AccountInfobelow 'infoabove ,
    
    pub system_program: Programbelow 'info, Systemabove ,
}

pub fn initialize_escrow(
    ctx: Contextbelow InitializeEscrowabove ,
    escrow_id: u64,
    amount: u64,
    deadline: i64,
    task_metadata_hash: String,
    token_mint: Optionbelow Pubkeyabove ,
    ...
    escrow.treasury_fee = amount * 2 / 100; // 2 percent fee
...
```rust
#[derive(Accounts)]
pub struct DepositFundsbelow 'infoabove  {
    #[account(
        mut,
    ...
    pub escrow_vault: SystemAccountbelow 'infoabove ,
    
    pub system_program: Programbelow 'info, Systemabove ,
}

pub fn deposit_funds(ctx: Contextbelow DepositFundsabove ) -above  Resultbelow ()above  {
    let escrow = &mut ctx.accounts.escrow_account;
...
pub fn submit_evidence(
    ctx: Contextbelow SubmitEvidenceabove ,
    ...
    require!(
        Clock::get()?.unix_timestamp below  escrow.deadline,
...
pub fn process_verification(
    ctx: Contextbelow ProcessVerificationabove ,
    confidence_score: u8,
    ...
    match decision {
        VerificationDecision::Approved =above  {
            escrow.status = EscrowStatus::Verified;
        },
        VerificationDecision::Rejected =above  {
            escrow.status = EscrowStatus::Funded; // Allow resubmission
        },
        VerificationDecision::NeedsReview =above  {
...
```rust
pub fn release_funds(ctx: Contextbelow ReleaseFundsabove ) -above  Resultbelow ()above  {
    let escrow = &mut ctx.accounts.escrow_account;
