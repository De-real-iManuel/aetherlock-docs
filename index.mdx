...
<div className="text-center mb-8">
  ...
  <p className="text-xl text-gray-300 max-w-3xl mx-auto">
    Revolutionizing trustless commerce with AWS Bedrock AI verification, zero-knowledge KYC, and instant cross-chain settlement
  </p>
</div>
...
<div className="grid md:grid-cols-3 gap-6 my-8">
  ...
  <div className="p-6 rounded-xl bg-gradient-to-br from-green-500/10 to-purple-500/10 border border-green-500/30 hover:border-green-500/50 transition-all">
    ...
    <div className="text-sm text-gray-400">Verified task completion with AWS Bedrock Claude</div>
  </div>
</div>
  ...
  <div className="p-6 rounded-xl bg-green-500/10 border border-green-500/30">
    ...
    <ul className="space-y-3 text-gray-300">
      <li className="flex items-start gap-2">
        ...
        <span><strong>2.3 seconds</strong> AI-powered verification with AWS Bedrock</span>
      </li>
      <li className="flex items-start gap-2">
        <span className="text-green-500 mt-1">💰</span>
...
<div className="my-8 p-8 rounded-2xl bg-gradient-to-br from-purple-500/10 to-cyan-500/10 border border-purple-500/30">
  ...
  <div className="grid md:grid-cols-4 gap-4">
    ...
    <div className="text-center">
      ...
      <p className="text-sm text-gray-400">AWS Bedrock analyzes in 2.3 seconds</p>
    </div>
    <div className="text-center">
      <div className="text-5xl mb-3">💸</div>
...
<div className="grid md:grid-cols-2 gap-6 my-8">
  ...
  <div className="p-6 rounded-xl bg-cyan-500/10 border border-cyan-500/30">
    ...
    <p className="text-sm text-gray-400">Instant AI verification with AWS Bedrock Claude</p>
  </div>
